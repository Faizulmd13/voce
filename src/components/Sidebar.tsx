    ...
    <aside className="w-64 bg-neutral-900 border-r border-neutral-800/60 flex flex-col justify-between p-5 select-none h-full shrink-0">
      ...
      <div>
        ...
        <nav className="space-y-1.5">
          <button
            ...
            className={`w-full flex items-center gap-3 px-3.5 py-2.5 rounded-lg text-sm font-medium transition-colors ${activePage === 'home'
          ...
          <button
            ...
            className={`w-full flex items-center gap-3 px-3.5 py-2.5 rounded-lg text-sm font-medium transition-colors ${activePage === 'bookmarks'
              ? 'bg-neutral-800/90 text-neutral-100 border border-neutral-700/50 shadow-sm'
              : 'text-neutral-400 hover:text-neutral-200 hover:bg-neutral-800/40'
              }`}
          >
          ...
          <button
            ...
            className={`w-full flex items-center gap-3 px-3.5 py-2.5 rounded-lg text-sm font-medium transition-colors ${activePage === 'history'
              ? 'bg-neutral-800/90 text-neutral-100 border border-neutral-700/50 shadow-sm'
              : 'text-neutral-400 hover:text-neutral-200 hover:bg-neutral-800/40'
              }`}
          >
      ...
      <div className="border-t border-neutral-800/60 pt-3">
        <button
          ...
          className={`w-full flex items-center gap-3 px-3.5 py-2.5 rounded-lg text-sm font-medium transition-colors ${activePage === 'settings'
            ? 'bg-neutral-800/90 text-neutral-100 border border-neutral-700/50 shadow-sm'
            : 'text-neutral-400 hover:text-neutral-200 hover:bg-neutral-800/40'
            }`}
        >
